...
class Movie
{
    ...
    {
        //write the SQL query that returns all movies from the tbl_movies table
        // $query = 'SELECT * FROM '.$this->movies_table;


        //write the SQL query that returns all movies with its genre
    ...
    public function getMovieByGenre($genre){
        ...
        // this prepares the query statement
        $stmt = $this->conn->prepare($query);
